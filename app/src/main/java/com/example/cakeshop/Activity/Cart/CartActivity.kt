package com.example.cakeshop.Activity.Cart
...
import com.example.cakeshop.Helper.ManagmentCart
...
fun CartScreen(
    ...
    // This is a reactive state list
    val cartItem = remember { mutableStateListOf<ItemsModel>().apply {
        addAll(managmentCart.getListCart())
    } }
    ...
    Column(
        ...
        if (cartItem.isEmpty()) {
            ...
            CartList(
                ...
                // Clear and re-add to trigger recomposition
                cartItem.clear()
                cartItem.addAll(managmentCart.getListCart())
                calculatorCart(managmentCart, tax)
            }
